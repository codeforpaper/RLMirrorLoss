...
def mirror_modify(mirror_original, game = None):
    position_18_lr = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [5, 6], 4: [7, 8], 5: [6, 7], 6: [9, 10], 7: [8, 9],
                    8: [10, 11], 9: [12, 13], 10: [11, 12], 11: [13, 14], 12: [15, 16], 13: [14, 15], 14: [17, 18],
                    15: [16, 17]}

    if game == 'Pong':
        return mirror_original
    elif game == 'Alien':
        position = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [5, 6], 4: [7, 8], 5: [6, 7], 6: [9, 10], 7: [8, 9],
                    8: [10, 11], 9: [12, 13], 10: [11, 12], 11: [13, 14], 12: [15, 16], 13: [14, 15], 14: [17, 18],
                    15: [16, 17]}
    elif game == 'Assault':
        position = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [6, 7], 4: [5, 6]}
    elif game == 'Asterix':
        ...
        position = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [5, 6], 4: [7, 8], 5: [6, 7], 6: [9, 10], 7: [8, 9],
                    8: [10, 11], 9: [12, 13],
                    10: [11, 12], 11: [13, 14], 12: [15, 16], 13: [14, 15], 14: [17, 18], 15: [16, 17]}
    elif game == 'AirRaid':
        position = {0: [0, 2], 1: [3, 4], 2: [2, 3], 3: [5, 6], 4: [4, 5]}
    elif game == 'Amidar':
        position = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [5, 7], 4: [8, 9], 5: [7, 8], 6: [9, 10]}
    elif game == 'Boxing':
        position = {0: [0, 3], 1: [4, 5], 2: [3, 4], 3: [5, 6], 4: [7, 8], 5: [6, 7], 6: [9, 10], 7: [8, 9],
                    8: [10, 11], 9: [12, 13], 10: [11, 12], 11: [13, 14], 12: [15, 16], 13: [14, 15], 14: [17, 18],
                    15: [16, 17]}
    elif game == 'Gravitar':
        position = position_18_lr
    elif game == 'Jamesbond':
        position = position_18_lr
    elif game == 'Carnival':
        position = {0: [0, 2], 1: [3, 4], 2: [2, 3], 3: [5, 6], 4: [4, 5]}
